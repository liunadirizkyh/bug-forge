  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-zinc-800/50 bg-[#0B0B0D]/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 sm:px-6 py-4">
        ...
        >
          <div className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-xl bg-[#FF7527] text-[#0B0B0D] transition-transform group-hover:scale-105 shadow-lg shadow-[#FF7527]/20">
            <BugIcon className="h-5.5 w-5.5 sm:h-6 sm:w-6" />
          </div>
        ...
        <nav className="flex items-center gap-4 sm:gap-6">
          <button
            onClick={() => setActiveTab("home")}
            className={`text-xs sm:text-sm font-medium transition-colors hover:text-white focus:outline-none ${
