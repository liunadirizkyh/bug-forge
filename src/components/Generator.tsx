...
export function Generator() {
  ...
  const handleFillSample = () => {
    ...
    setPlatform("Generic");
    setDescription(
      "Terdapat celah Stored XSS pada kolom Bio di halaman profil pengguna. Input tidak disanitasi dengan benar sehingga script berbahaya dapat dieksekusi saat profil dikunjungi oleh pengguna lain."
    );
    setSteps(
      "1. Login ke aplikasi sebagai attacker.\n2. Buka halaman /settings/profile.\n3. Masukkan payload berikut ke dalam kolom Bio: <img src=x onerror=alert(document.cookie)>\n4. Simpan perubahan.\n5. Kunjungi profil publik attacker dengan akun korban, popup alert akan muncul."
    );
  };
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-12 text-left">
          ...
          <p className="text-base sm:text-lg text-zinc-400 font-normal">
            Isi catatan kasar di kiri — biar AI yang bikin rapi.
          </p>
        </div>
            ...
            <form onSubmit={handleGenerate} className="space-y-6 text-left">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Apa bug-nya, di mana, kenapa berbahaya..."
                  rows={4}
              ...
              {isGenerating ? (
                <div className="flex flex-col items-center justify-center text-center p-8">
                  ...
                  <p className="text-zinc-400 font-medium">
                    AI sedang menganalisis celah keamanan &amp; menyusun laporan...
                  </p>
                </div>
              ) : generatedReport ? (
                ...
                <div className="flex flex-col items-center justify-center text-center p-8">
                  ...
                  <p className="text-zinc-600 text-xs mt-2 max-w-xs">
                    Isi formulir di sebelah kiri atau klik &quot;Isi Contoh Catatan&quot; untuk melihat keajaiban AI.
                  </p>
                </div>
              )}
            </div>
